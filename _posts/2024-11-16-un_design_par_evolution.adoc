...
Il existe des nombres qui sont encore plus grand que le nombre d'atomes dans l'univers visible et de loin, et voici deux exemples :
...
On utilise donc des **métaheuristiques** (comme les algorithmes génétiques), qui permettent de trouver des
